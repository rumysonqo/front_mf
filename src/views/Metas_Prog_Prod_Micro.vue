...
async function get_metas_prog_prod_micro(){
  try {
      const response = await axios.get(url+'metas_prog_prod_micro/'+cod_prg+'/'+cod_prd+'/'+cod_mic)
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="sel">
          ...
          <select v-model="cod_prd" @change="get_metas_prog_prod_micro()" class="form-select form-select-md mb-3">
          ...
          <select v-model="cod_mic" @change="get_metas_prog_prod_micro()" class="form-select form-select-md mb-3">
